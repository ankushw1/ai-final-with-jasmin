...
const Account = require("../models/Management");
const upload = require("../utils/managementFileUpload"); // Multer upload
const fs = require('fs');
...
<p style="text-align: center;">
  <a href="https://smsc.aimobile.in/saleslogin" 
     style="
...
exports.createAccount = async (req, res) => {
  upload(req, res, async (err) => {
    ...
    try {
      ...
      const secret = speakeasy.generateSecret({ name: `AI_Sales (${email})` });
...
exports.getAllAccounts = async (req, res) => {
  try {
    ...
    const managements = await Account.find(filter)
